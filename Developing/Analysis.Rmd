...
Este script se hace con el propósito de analizar y estimar modelos de tiempo de viaje a partir de los datos obtenidos de Fiscalización. En una primera instancia se hace un análisis descriptivo de las distintas variables generadas, desagregando aquellos buses que usan torniquete mariposa de aquellos que no tienen.
...
$T = c + t_{L} \cdot L  + t_{Y}\cdot Y + \sum_{r} t_{r} \gamma_{r} $
...
El segundo modelo corresponde a una extensión del primero, pero considerando una dummy por la demanda en aquellas expediciones que utiliza torniquete.
